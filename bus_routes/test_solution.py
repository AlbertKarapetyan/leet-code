...
from num_buses_to_destination import Solution
...
class TestSolution(unittest.TestCase):
    ...
    def test_num_buses_to_destination(self):        
        ...
        source = 1
        target = 6
        self.assertEqual(self.solution.num_buses_to_destination(routes, source, target), 2)
        ...
        source = 15
        target = 12
        self.assertEqual(self.solution.num_buses_to_destination(routes, source, target), -1)
